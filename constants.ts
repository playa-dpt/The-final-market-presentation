    ...
    scripts: [
      {
        ...
        script: '“先生，在欧洲严苛的动物福利法规下，T11 是唯一合法的训练替代方案。利用‘双向语音’实现‘声音召回 (Voice Recall)’，完全替代电击。这不仅合规，更展示了猎人对犬只的高级掌控力，符合‘道德狩猎’的崇高标准。”',
        psychology: '价值观共鸣 (Value Alignment)：将产品功能上升到道德高度，消除用户的负罪感。'
      },
      {
        title: '驱赶狩猎 (Driven Hunt)',
        painPoint: '多只狗协同困难，不知道狗在哪里',
        script: '“专为欧洲流行的‘驱赶式狩猎 (Driven Hunt)’定制。我们的 App 支持单屏追踪 20+ 犬只，配合 T11 的‘环境音监听’，队长可以实时判断猎犬是正在追踪（吠叫）还是被困。这是保障犬只安全和狩猎效率的必备战术工具。”',
