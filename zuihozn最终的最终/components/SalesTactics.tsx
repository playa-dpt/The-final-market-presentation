          ...
          <div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-6 grid grid-cols-1 xl:grid-cols-3 gap-8">
              ...
              <div className="xl:col-span-2 flex flex-col space-y-8 min-w-0">
                ...
                {/* Chart Area - Fixed flex layout for mobile */}
                <div className="bg-white rounded-xl border border-gray-200 p-4 h-64 flex flex-col min-w-0 relative">
                  <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-4 flex items-center flex-shrink-0">
                    <TrendingUp size={14} className="mr-1.5" /> 销量增长预测 (vs 竞品)
                  </h4>
                  {/* Added relative and explicit sizing to help responsive container on mobile */}
